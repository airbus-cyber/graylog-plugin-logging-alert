...
public class MessagesSearches {
    ...
    public String getAggregationAlertIdentifier(int aggregationTime, String suffixID) {
        ...
        try {
            ...
            String query = messageFormat.format(new Object[]{"id", suffixID});
            ...
            if (result != null) {
                ...
                if(!result.getResults().isEmpty()) {
                    ...
                    return result.getResults().get(0).getMessage().getField("id").toString();
                }
            }
