...
public class LoggingAlertTest {
	...
	public void callWithSeverityHigh() throws AlarmCallbackException, AlarmCallbackConfigurationException {
		List<String> listAggegationFields = Collections.singletonList(USER);
		initializeConfiguration(getConfigMap("high", "Body", listAggegationFields, 0, 0));
	...
	public void callWithSeverityMedium() throws AlarmCallbackException, AlarmCallbackConfigurationException {
		List<String> listAggegationFields = Collections.singletonList(USER);
		initializeConfiguration(getConfigMap("medium", "Body", listAggegationFields, 0, 0));
	...
	public void callWithSeverityLow() throws AlarmCallbackException, AlarmCallbackConfigurationException {
		List<String> listAggegationFields = Collections.singletonList(USER);
		initializeConfiguration(getConfigMap("low", "Body", listAggegationFields, 0, 0));
