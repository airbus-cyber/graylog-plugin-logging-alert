...
graylog.send('{ "version": "1.1", "host": "example.org", "short_message": "AAA input1", "_stream": "input" }\0'.encode())
...
# look at the id of the log and set it as the alert_id here
...
graylog.send('{ "version": "1.1", "host": "example.org", "short_message": "AAA input2", "_stream": "input" }\0'.encode())
